...
must_haves:
  ...
  artifacts:
    ...
    - path: "e2e/fixtures/fake-runtime.ts"
      provides: "Reusable deterministic fake runtime helper additions only if needed for browser-visible cancellable runs"
...
<task type="auto" tdd="true">
  ...
  <done>Phase 12 has a deterministic no-key mobile Console E2E proving browse/select, multi-line send, streamed/terminal UI, sessions/run-context reachability, and cancel-or-terminal behavior across required projects.</done>
</task>
...
<success_criteria>
- MVER-03: New browser E2E starts a fake/no-key Console flow, observes streamed/terminal UI, opens agent/session/run-context surfaces, and cancels or reaches terminal status.
